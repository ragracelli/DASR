...
# -- IMPORTANT
#data=/home/gracelli/databases/aishell/data_aishell # Modify to your aishell data path
#data=/home/gracelli/databases/ljspeech/data_split
data=/home/gracelli/databases/uaspeech/control/data_split
#data=/home/gracelli/databases/uaspeech/dysarthric/data_split
...
LFR_n=4  # Low Frame Rate: number of frames to skip
...
if [ $stage -le 0 ]; then
    ...
    #local/aishell_data_prep.sh /home/gracelli/databases/aishell/data_aishell/wav /home/gracelli/databases/aishell/data_aishell/transcript || exit 1;
...
if [ $stage -le 1 ]; then
    ...
    ### But you can utilize Kaldi recipes in most cases
    fbankdir=fbank
    for data in train test dev; do # linha original
