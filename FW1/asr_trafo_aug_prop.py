...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Uso: python asr_trafo_aug_prop.py <diretório_da_base_de_dados>")
        sys.exit(1)
...
saveto_aug = "U:\\home\\gracelli\\databases\\uaspeech\\dysarthric\\wavs\\aug_prop\\" + base
...
read_transcript(os.path.join(saveto_aug, "U:\\home\\gracelli\\databases\\uaspeech\\dysarthric\\wavs\\aug_prop\\" + base + "\\ua_transcript.txt"))
...
class DisplayOutputs(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):       
        ...
        with open(base + '_wras_aug_prop.csv', 'a') as f:
...
with open("resultados.txt", "a") as file:
    file.write(f"{base}_aug_prop| Acurácia: {word_accuracy}\n")
