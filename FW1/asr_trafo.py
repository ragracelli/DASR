...
#    if len(sys.argv) < 2:
#        print("Uso: python asr_trafo_noaug.py <diretório_da_base_de_dados>")
#        sys.exit(1)
...
class DisplayOutputs(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):       
        ...
        with open('wras_uacontrol.csv', 'a') as f:
...
history = model.fit(ds, validation_data=val_ds, callbacks=[display_cb, checkpoint], epochs=1)
model.summary()
#print(base)
...
#    file.write(f"{base}_noaug| Acurácia: {word_accuracy}\n")