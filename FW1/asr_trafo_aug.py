...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Uso: python asr_trafo_aug.py <diretório_da_base_de_dados>")
        sys.exit(1)
    ...
    def __init__(self, embed_dim, num_heads, feed_forward_dim, dropout_rate=0.1):
        ...
        self.ffn = keras.Sequential(
            [
                ...
                layers.Dense(embed_dim, trainable=False),
            ]
        )
...
saveto = "/workspace/ragracelli/databases/uaspeech/dysarthric/wavs/original/" + base
saveto_aug = "/workspace/ragracelli/databases/uaspeech/dysarthric/wavs/aug/" + base
...
read_transcript(os.path.join(saveto, "/workspace/ragracelli/databases/uaspeech/dysarthric/wavs/original/transcript/ua_transcript.txt"))
read_transcript(os.path.join(saveto_aug, "/workspace/ragracelli/databases/uaspeech/dysarthric/wavs/aug/transcript/ua_transcript.txt"))
...
with open("resultados.txt", "a") as file:
    file.write(f"{base}_aug| Acurácia: {word_accuracy}\n")
